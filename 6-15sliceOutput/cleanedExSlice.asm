...
movzx eax byte ptr [edi+ecx*1] [0xb7f8be46]
mov ecx edx	 
...
movzx eax byte ptr [edi+ecx*1] [0xb7f8be41]
mov ecx edx	 
...
movzx eax byte ptr [edi+ecx*1] [0xb7f8be42]
mov ecx edx	 
...
movzx eax byte ptr [edi+ecx*1] [0xb7f8be45]
mov ecx edx	 
