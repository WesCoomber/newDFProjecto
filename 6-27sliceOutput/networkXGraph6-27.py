...
def graphJump(nameOfNode, listOfFlagsConsumed):
    for flag in listOfFlagsConsumed:
        addJumpEdge(FlagRegDict[str(flag)], nameOfNode, '(' + str(flag) + ')EndofSliceValue')
    addJumpNode(nameOfNode)
    JumpInstList.append(nameOfNode)
